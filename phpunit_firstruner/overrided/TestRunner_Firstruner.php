 ...
 */
final class TestRunner_Firstruner extends BaseTestRunner
{
     ...
     * @throws Exception
     */
    public function run(TestSuite_Firstruner $suite, array $arguments = [], array $warnings = [], bool $exit = true): TestResult
    {
        ...
        if (is_int($arguments['repeat']) && $arguments['repeat'] > 0) {
            $_suite = new TestSuite_Firstruner();
        ...
        if ($this->printer === null) {
            if (isset($arguments['printer'])) {
                ...
                $this->printer = $this->createPrinter(ResultPrinter_firstruner::class, $arguments);
            }
        }
    ...
    private function handleConfiguration(array &$arguments): void
    {
        ...
        if (isset($arguments['configurationObject'])) {
            ...
            if (!isset($arguments['noLogging'])) {
                if ($loggingConfiguration->hasText()) {
                    $arguments['listeners'][] = new ResultPrinter_firstruner(
        ...
        $arguments['colors']                                          = $arguments['colors'] ?? ResultPrinter_firstruner::COLOR_DEFAULT;
    ...
    * @throws Exception
    */
    public function getTest(string $suiteClassFile, $suffixes = ''): ?TestSuite_Firstruner
    {
        $suites = parent::getTest($suiteClassFile, $suffixes);
        return new TestSuite_Firstruner($suites);
    }
}