...
define("cli_unittest", cli_white . cli_cyan_bg . cli_clreol);
define("cli_unittest_success", cli_white . cli_green_bg . cli_clreol);
define("cli_unittest_fail", cli_white . cli_red_bg . cli_clreol);
define("cli_unittest_warn", cli_black . cli_yellow_bg . cli_clreol);
define("cli_unittest_skip", cli_black . cli_grey_bg . cli_clreol);
define("cli_unittest_risk", cli_black . cli_light_red_bg . cli_clreol);
define("cli_unittest_error", cli_black . cli_magenta_bg . cli_clreol);
define("cli_unittest_incomplete", cli_black . cli_white_bg . cli_clreol);
define("cli_unittest_memoryexceed", cli_black . cli_light_red_bg . cli_clreol);